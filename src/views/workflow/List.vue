    ...
    <div class="flow-list">
      <el-table :data="tableData" style="width: 100%" v-loading="loading">
        ...
        <el-table-column label="操作" width="200">
          <template #default="scope">
            <el-button type="primary" text @click="$_goDetail(scope.row)"
              >查看流程</el-button
            >
          </template>
        </el-table-column>
...
import { findDefinitionByPage, createFlow } from "@/api/workflow";
...
export default {
  ...
  methods: {
    ...
    $_goDetail(record) {
      let flowModuleId = record.flowModuleId;
